...
export const dataScienceItems = [
    ...
    { image: NN, label: "Neural Networks", width: 35, height: 35, left: 5, right: 10 },
    { image: Shiny, label: "R Shiny", width: 35, height: 35, left: 5, right: 10 },
    { image: Python, label: "Python", width: 40, height: 40, left: 5, right: 10 }];